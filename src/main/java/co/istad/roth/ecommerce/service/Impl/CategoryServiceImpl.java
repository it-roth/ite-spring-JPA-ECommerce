package co.istad.roth.ecommerce.service.Impl;
...
import co.istad.roth.ecommerce.mapper.CategoryMapper;
...
//    }
    ...
    public List<CategoryResponse> getSubCategories(Integer parentCategoryId) {
        ...
        return categoryRepository.findAllByIsDeletedAndParentCategory(false,category).stream()
