...
public class AppException {
    ...
    public ResponseEntity<?> handleServiceException(
        ...
        co.istad.roth.ecommerce.exception.ErrorResponse<?> errorResponse = co.istad.roth.ecommerce.exception.ErrorResponse.builder()
                .status(false)
    ...
    public ErrorResponse<?> handleValidationException(
        ...
        return co.istad.roth.ecommerce.exception.ErrorResponse.builder()
                .status(false)
